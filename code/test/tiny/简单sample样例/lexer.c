...
int main(int argc, char* argv[]) {
	FILE* input_file = fopen("G:/04code/10Qt/byyl-combined6/test/tiny/简单sample样例/sample.tny", "r");
	if (input_file == NULL) {
		printf("Failed to open input file");
		return 1;
	}
	FILE* output_file = fopen("G:/04code/10Qt/byyl-combined6/test/tiny/简单sample样例/sample.lex", "w");
	if (output_file == NULL) {
